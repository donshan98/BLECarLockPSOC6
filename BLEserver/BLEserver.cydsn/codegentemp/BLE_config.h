 ...
 */
#define CY_BLE_CARLOCK_SERVICE_INDEX   (0x00u) /* Index of CarLock service in the cy_ble_customs array */
#define CY_BLE_CARLOCK_DEBUGLED_CHAR_INDEX   (0x00u) /* Index of debugLED characteristic */
#define CY_BLE_CARLOCK_DEBUGLED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_CARLOCK_SERVICE_HANDLE   (0x0010u) /* Handle of CarLock service */
#define CY_BLE_CARLOCK_DEBUGLED_DECL_HANDLE   (0x0011u) /* Handle of debugLED characteristic declaration */
#define CY_BLE_CARLOCK_DEBUGLED_CHAR_HANDLE   (0x0012u) /* Handle of debugLED characteristic */
#define CY_BLE_CARLOCK_DEBUGLED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
