...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x06u, 0x09u, 0x4Du, 0x79u,
        0x43u, 0x61u, 0x72u, 0x11u, 0x07u, 0x73u, 0x3Du,
        0x40u, 0x4Du, 0xECu, 0x9Au, 0x20u, 0xBAu, 0xD2u,
        0x45u, 0xA0u, 0xCAu, 0x31u, 0x77u, 0xE0u, 0xC6u,
...
static uint8_t cy_ble_attValues[0x26u] = {
    /* Device Name */
    (uint8_t)'M', (uint8_t)'y', (uint8_t)'C', (uint8_t)'a', (uint8_t)'r', 
    ...
    (uint8_t)'t', (uint8_t)'o', (uint8_t)'g', (uint8_t)'g', (uint8_t)'l', (uint8_t)'e', (uint8_t)' ', (uint8_t)'d',
(uint8_t)'e', (uint8_t)'b', (uint8_t)'u', (uint8_t)'g', (uint8_t)' ', (uint8_t)'L', (uint8_t)'E', (uint8_t)'D', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* CarLock */
    { 0x73u, 0x3Du, 0x40u, 0x4Du, 0xECu, 0x9Au, 0x20u, 0xBAu, 0xD2u, 0x45u, 0xA0u, 0xCAu, 0x31u, 0x77u, 0xE0u, 0xC6u },
    /* debugLED */
    { 0x43u, 0x35u, 0x8Du, 0x17u, 0xD7u, 0xEAu, 0x48u, 0xB9u, 0x78u, 0x44u, 0x33u, 0x16u, 0xA0u, 0xD6u, 0x15u, 0x1Bu },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Bu] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* CarLock UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* debugLED UUID */
    { 0x0001u, (void *)&cy_ble_attValues[21] }, /* debugLED */
    { 0x0010u, (void *)&cy_ble_attValues[22] }, /* Characteristic User Description */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x13u] = {
    ...
    { 0x0012u, 0xD6A0u /* debugLED                            */, 0x09080100u /* wr    */, 0x0013u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0013u, {{0x0010u, (void *)&cy_ble_attValuesLen[10]}} },
};
